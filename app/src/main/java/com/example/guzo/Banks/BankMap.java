...
public class BankMap extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!bankId.isEmpty()){
            getDetailHotel(bankId);
            // cityIds.setCityId(cityId);
        }

    }

    private void getDetailHotel(String bankId) {
        Bank.child(bankId).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                Banks mus = dataSnapshot.getValue(Banks.class);
                assert mus != null;
                flat = mus.getLat();
                flon = mus.getLon();
    ...
    public void mapOperations() {
        ...
        if (MarkerPoints.size() >= 2) {
          ...
          BankMap.FetchUrl FetchUrl = new BankMap.FetchUrl();
    ...
    private class FetchUrl extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            BankMap.ParserTask parserTask = new BankMap.ParserTask();
