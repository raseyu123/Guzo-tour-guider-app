...
import com.example.guzo.Museums.DataParser;
...
public class HotelMap extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.mapHotel);
    ...
    private void getDetailHotel(String hotelId) {
        hotel.child(hotelId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                Hotels mus = dataSnapshot.getValue(Hotels.class);
                assert mus != null;
                flat = mus.getLat();
                flon = mus.getLon();
    ...
    public void mapOperations() {
        ...
        if (MarkerPoints.size() >= 2) {
            ...
            HotelMap.FetchUrl FetchUrl = new HotelMap.FetchUrl();
    ...
    private class FetchUrl extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            HotelMap.ParserTask parserTask = new HotelMap.ParserTask();
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
        ...
        protected List<List<HashMap<String, String>>> doInBackground(String... jsonData) {
            ...
            try {
                ...
                com.example.guzo.Museums.DataParser parser = new DataParser();
